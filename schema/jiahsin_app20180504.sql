...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 04, 2018 at 09:33 AM
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `health_class` (`health_class_code`)
...
INSERT INTO `user` (`id`, `code`, `pass`, `fullname`, `role_code`, `com_code`, `dept_code`, `posi_code`, `email`, `phone_extend`, `about`, `common_disease`, `occupational_disease`, `labor_accident`, `poison_area`, `health_class_code`, `expiry_health_check`, `status`) VALUES
...
(10, 'I11174', '$2y$08$dW9vL1JmemNGcW9iakxUZ.e0JUUr7OFtCsG76gx6vcuc3hWTwbd0W', 'Phạm Thị Kiều Trinh', 'USR', 'JHV', 'AC', 'EMP', 'Trinh.Pham@jiahsin.com.vn', '', '', 0, 0, 0, 0, '5', NULL, 1),
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_5` FOREIGN KEY (`health_class_code`) REFERENCES `health_class` (`code`) ON UPDATE CASCADE;
COMMIT;
