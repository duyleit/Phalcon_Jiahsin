...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 21, 2018 at 09:34 AM
...
INSERT INTO `medicine_basic` (`id`, `code`, `name`, `unit`, `specification`, `approval_no`, `manufactory`) VALUES
(1, '', 'ALPHA CHOAY', '1', '500mg', NULL, 'Công ty dược phẩm Long An'),
(2, 'AS0026', 'ALAXAN', '2', '125mg*12', NULL, 'Công ty dược phẩm Long An'),
(3, '', '3B', '1', '50mg', NULL, 'Công ty cổ phần dược phẩm Hậu Giang');
...
(1, 'I12758', '$2y$08$MEE1c2Y2S2FkS3Z0TXVYZeuucp9tJkmSlBwyM4se.T2CQsRkpP6P.', 'John Nguyen', 'ADM', 'JHV', 'HR', 'TLD', 'PhucNguyen.Pham@jiahsin.com.vn', '1159', '', 1),
