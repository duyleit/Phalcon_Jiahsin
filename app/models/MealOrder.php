...
class MealOrder extends \Phalcon\Mvc\Model
{
     ...
     * @Primary
     * @Identity
     * @Column(column="id", type="integer", length=21, nullable=false)
     */
    protected $id;
     ...
     *
     * @var string
     * @Column(column="date_create", type="string", nullable=true)
     */
     ...
     *
     * @var string
     * @Column(column="date_modify", type="string", nullable=true)
     */
     ...
     * @return MealOrder[]|MealOrder|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return MealOrder|\Phalcon\Mvc\Model\ResultInterface
     */
