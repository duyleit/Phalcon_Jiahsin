...
<div class="container-fluid jhv-top3" style="background: url({{ url('img/role/top-bg.jpg') }}) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="col-sm-7 text-right">
                ...
                <a href="{{ url('role/search') }}" class="btn btn-default btn-sm"><i class="fa fa-list"></i> List All</a>
                <a href="{{ url('role/new') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add</a>
            </div>
