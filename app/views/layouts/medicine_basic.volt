...
{% if session.has('user-code') %}
    <div class="container-fluid navbar-sub text-center">
        <div class="btn-group">
            <a href="{{ url('medicine_basic/search') }}" class="btn btn-default"><i class="fa fa-list"></i> Medicine Basic</a>
            <a href="{{ url('medicine_stock/search') }}" class="btn btn-primary"><i class="fa fa-list"></i> Medicine Stock</a>
        </div>
    </div>
