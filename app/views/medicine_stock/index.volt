...
{{ form("medicine_stock/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ select_static("forbidden", ['0':'No','1':'Yes'], "useEmpty":true, "emptyText":"Select...", "class" : "form-control", "id" : "fieldForbidden") }}
    </div>
</div>
