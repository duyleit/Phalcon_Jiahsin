...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ select("role_code", role, "using":["code","name"], "class" : "form-control", "id" : "fieldRoleCode") }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ select("com_code", company, "using":["code","name"], "class" : "form-control", "id" : "fieldComCode") }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ select("dept_code", department, "using":["code","name"], "class" : "form-control", "id" : "fieldDeptCode") }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ select("posi_code", position, "using":["code","name"], "class" : "form-control", "id" : "fieldPosiCode") }}
    </div>
</div>
