...
{{ form("medicine_basic/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ select("unit_code", unit, "using":["code","name"], "required":"required", "useEmpty":true, "emptyText":"Select...", "class" : "form-control", "id" : "fieldUnit") }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ numeric_field("min_stock", "type" : "numeric", "class" : "form-control", "id" : "fieldMinStock") }}
    </div>
</div>
