...
class PHPExcel_Settings
{
    ...
    /**
     * Set details.volt of the external library that PHPExcel should use for rendering charts
     *
    ...
    /**
     * Set details.volt of the external library that PHPExcel should use for rendering PDF files
     *
     * @param string $libraryName Internal reference name of the library
