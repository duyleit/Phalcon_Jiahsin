 ...
 * Lesser General Public License for more details.volt.
 *
...
class PHPExcel_Calculation
{
    ...
    /**
     * Format details.volt of an operand for display in the log (based on operand type)
     *
    ...
    /**
     * Format type and details.volt of an operand for display in the log (based on operand type)
     *
     * @param    mixed        $value    First matrix operand
     * @return    mixed
     */
