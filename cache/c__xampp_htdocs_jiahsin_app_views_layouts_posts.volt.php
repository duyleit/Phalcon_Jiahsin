...
<?php if ($this->session->has('user-code')) { ?>
    <div class="container-fluid navbar-sub text-center">
        <div class="btn-group">
            <a href="<?= $this->url->get('posts/search') ?>" class="btn btn-primary"><i class="fa fa-book"></i> Blog</a>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="col-sm-7 text-right">
                <a href="<?= $this->url->get('posts') ?>" class="btn btn-default btn-sm"><i class="fa fa-search"></i> Advanced Search</a>
                <a href="<?= $this->url->get('posts/search') ?>" class="btn btn-default btn-sm"><i class="fa fa-list"></i> List</a>
                <a href="<?= $this->url->get('posts/new') ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Add</a>
            </div>
