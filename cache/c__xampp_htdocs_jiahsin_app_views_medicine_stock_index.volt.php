...
<?= $this->tag->form(['medicine_stock/search', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
...
<div class="form-group">
    <label for="fieldUserCode" class="col-sm-2 control-label">User</label>
    <div class="col-sm-10">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <?= $this->tag->selectStatic(['forbidden', ['0' => 'No', '1' => 'Yes'], 'useEmpty' => true, 'emptyText' => 'Select...', 'class' => 'form-control', 'id' => 'fieldForbidden']) ?>
    </div>
</div>
