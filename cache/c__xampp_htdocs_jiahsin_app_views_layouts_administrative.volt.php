...
<div class="container-fluid jhv-top3" style="background: url(<?= $this->url->get('img/administrative/top-bg.jpg') ?>) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
        ...
        <div class="btn-group">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<?= $this->url->get('administrative/medicine_report') ?>">Medicine</a></li>
                </ul>
            </div>
