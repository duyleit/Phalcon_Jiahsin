...
<form method="POST" action="addcomkhach" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <?= $this->tag->textField(['donbanrieng', 'size' => 30, 'required' => 'required', 'class' => 'form-control', 'value' => 0, 'id' => 'fieldDonBanRieng']) ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <?= $this->tag->textField(['anbuffet', 'size' => 30, 'required' => 'required', 'class' => 'form-control', 'value' => 0, 'id' => 'fieldAnBuffet']) ?>
        </div>
    </div>
