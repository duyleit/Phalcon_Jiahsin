...
<form method="POST" action="adddem" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <?= $this->tag->textField(['mansuatdem', 'size' => 30, 'required' => 'required', 'class' => 'form-control', 'value' => 0, 'id' => 'fieldManSuatDem']) ?>
        </div>
    </div>
    <div class="form-group">
        <label for="fieldChaySuatDem" class="col-sm-3 control-label">Chay Suất Đêm: </label>
        <div class="col-sm-2">
            <?= $this->tag->textField(['chaysuatdem', 'size' => 30, 'required' => 'required', 'class' => 'form-control', 'value' => 0, 'id' => 'fieldChaySuatDem']) ?>
        </div>
    </div>
