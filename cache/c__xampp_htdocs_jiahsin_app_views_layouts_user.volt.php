...
<div class="container-fluid jhv-top3" style="background: url(<?= $this->url->get('img/user/top-bg.jpg') ?>) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="col-sm-7 text-right">
                ...
                <a href="<?= $this->url->get('user/search') ?>" class="btn btn-default btn-sm"><i class="fa fa-list"></i> List</a>
                <a href="<?= $this->url->get('user/new') ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Add</a>
            </div>
